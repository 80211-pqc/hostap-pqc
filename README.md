...
w1.fi hostap 오픈소스 프로젝트를 기반으로, 새로 제안·명세화한
...
- **원본 라이선스:** BSD-3-Clause (레포 내 `COPYING` 및 `README` 참조)
...
취약점 제보 절차와 정책은 `SECURITY.md`를 참조하십시오.
...
- hostap 자체에 대한 개선은 원본 프로젝트(w1.fi)에 제보해 주십시오.